...
import { PaymentInfoCreateNestedOneWithoutOrderInput } from '../payment-info/payment-info-create-nested-one-without-order.input';
...
@InputType()
export class OrderCreateWithoutShippingAddressInput {
    ...
    @Field(() => PaymentInfoCreateNestedOneWithoutOrderInput, {nullable:true})
