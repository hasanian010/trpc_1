...
import { IncomeUncheckedUpdateManyWithoutOrderNestedInput } from '../income/income-unchecked-update-many-without-order-nested.input';

@InputType()
export class OrderUncheckedUpdateWithoutShippingAddressInput {
    ...
    @Field(() => IncomeUncheckedUpdateManyWithoutOrderNestedInput, {nullable:true})
    incomes?: IncomeUncheckedUpdateManyWithoutOrderNestedInput;
}
