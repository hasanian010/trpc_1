...
import { RefundableUncheckedCreateNestedManyWithoutOrderInput } from '../refundable/refundable-unchecked-create-nested-many-without-order.input';
...
@InputType()
export class OrderUncheckedCreateWithoutShippingAddressInput {
    ...
    @Field(() => RefundableUncheckedCreateNestedManyWithoutOrderInput, {nullable:true})
    refundables?: RefundableUncheckedCreateNestedManyWithoutOrderInput;
