...
import { OrderProductUncheckedCreateNestedManyWithoutProductInput } from '../order-product/order-product-unchecked-create-nested-many-without-product.input';
...
@InputType()
export class ProductUncheckedCreateWithoutAttributeVariantsInput {
    ...
    @Field(() => OrderProductUncheckedCreateNestedManyWithoutProductInput, {nullable:true})
