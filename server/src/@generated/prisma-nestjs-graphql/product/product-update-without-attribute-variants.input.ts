...
import { OrderProductUpdateManyWithoutProductNestedInput } from '../order-product/order-product-update-many-without-product-nested.input';
...
@InputType()
export class ProductUpdateWithoutAttributeVariantsInput {
    ...
    @Field(() => OrderProductUpdateManyWithoutProductNestedInput, {nullable:true})
