...
import { ProductUpdateManyWithoutFlashNestedInput } from '../product/product-update-many-without-flash-nested.input';
...
export class FlashUpdateInput {
    ...
    @Field(() => ProductUpdateManyWithoutFlashNestedInput, {nullable:true})
    products?: ProductUpdateManyWithoutFlashNestedInput;
}
