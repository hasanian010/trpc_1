...
import { SellerUpdateOneWithoutReviewsNestedInput } from '../seller/seller-update-one-without-reviews-nested.input';
...
export class ReviewUpdateInput {
    ...
    @Field(() => SellerUpdateOneWithoutReviewsNestedInput, {nullable:true})
