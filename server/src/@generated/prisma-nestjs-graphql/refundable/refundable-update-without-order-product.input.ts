...
import { RefundUpdateManyWithoutRefundableNestedInput } from '../refund/refund-update-many-without-refundable-nested.input';

@InputType()
export class RefundableUpdateWithoutOrderProductInput {
    ...
    @Field(() => RefundUpdateManyWithoutRefundableNestedInput, {nullable:true})
    refunds?: RefundUpdateManyWithoutRefundableNestedInput;
}
