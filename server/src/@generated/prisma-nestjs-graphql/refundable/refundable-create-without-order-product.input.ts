...
import { RefundCreateNestedManyWithoutRefundableInput } from '../refund/refund-create-nested-many-without-refundable.input';

@InputType()
export class RefundableCreateWithoutOrderProductInput {
    ...
    @Field(() => RefundCreateNestedManyWithoutRefundableInput, {nullable:true})
    refunds?: RefundCreateNestedManyWithoutRefundableInput;
}
