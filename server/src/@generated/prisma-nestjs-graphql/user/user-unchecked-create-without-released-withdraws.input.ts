...
import { ProviderUncheckedCreateNestedManyWithoutUserInput } from '../provider/provider-unchecked-create-nested-many-without-user.input';
...
@InputType()
export class UserUncheckedCreateWithoutReleasedWithdrawsInput {
    ...
    @Field(() => ProviderUncheckedCreateNestedManyWithoutUserInput, {nullable:true})
