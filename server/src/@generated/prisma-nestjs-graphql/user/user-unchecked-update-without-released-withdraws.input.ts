...
import { RefundUncheckedUpdateManyWithoutUserNestedInput } from '../refund/refund-unchecked-update-many-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutReleasedWithdrawsInput {
    ...
    @Field(() => RefundUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
