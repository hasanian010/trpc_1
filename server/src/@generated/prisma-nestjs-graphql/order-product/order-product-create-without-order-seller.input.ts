...
import { RefundableCreateNestedManyWithoutOrderProductInput } from '../refundable/refundable-create-nested-many-without-order-product.input';

@InputType()
export class OrderProductCreateWithoutOrderSellerInput {
    ...
    @Field(() => RefundableCreateNestedManyWithoutOrderProductInput, {nullable:true})
    refundables?: RefundableCreateNestedManyWithoutOrderProductInput;
}
