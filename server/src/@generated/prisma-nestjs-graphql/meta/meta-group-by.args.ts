...
import { MetaOrderByWithAggregationInput } from './meta-order-by-with-aggregation.input';
import { MetaScalarFieldEnum } from './meta-scalar-field.enum';
import { MetaScalarWhereWithAggregatesInput } from './meta-scalar-where-with-aggregates.input';
...
@ArgsType()
export class MetaGroupByArgs {

    @Field(() => MetaWhereInput, {nullable:true})
    @Type(() => MetaWhereInput)
    where?: MetaWhereInput;

    @Field(() => [MetaOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<MetaOrderByWithAggregationInput>;

    @Field(() => [MetaScalarFieldEnum], {nullable:false})
    by!: Array<`${MetaScalarFieldEnum}`>;
