...
import { BankCreateNestedOneWithoutSellerInput } from '../bank/bank-create-nested-one-without-seller.input';
...
@InputType()
export class SellerCreateWithoutOrderSellersInput {
    ...
    @Field(() => BankCreateNestedOneWithoutSellerInput, {nullable:true})
    bank?: BankCreateNestedOneWithoutSellerInput;
