...
import { OrderSellerUpdateManyWithoutSellerNestedInput } from '../order-seller/order-seller-update-many-without-seller-nested.input';
...
@InputType()
export class SellerUpdateWithoutRefundablesInput {
    ...
    @Field(() => OrderSellerUpdateManyWithoutSellerNestedInput, {nullable:true})
    orderSellers?: OrderSellerUpdateManyWithoutSellerNestedInput;
