...
import { IncomeUncheckedCreateNestedManyWithoutSellerInput } from '../income/income-unchecked-create-nested-many-without-seller.input';
...
@InputType()
export class SellerUncheckedCreateWithoutOrderSellersInput {
    ...
    @Field(() => IncomeUncheckedCreateNestedManyWithoutSellerInput, {nullable:true})
    incomes?: IncomeUncheckedCreateNestedManyWithoutSellerInput;
