...
import { RefundableUncheckedUpdateManyWithoutSellerNestedInput } from '../refundable/refundable-unchecked-update-many-without-seller-nested.input';
...
@InputType()
export class SellerUncheckedUpdateWithoutOrderSellersInput {
    ...
    @Field(() => RefundableUncheckedUpdateManyWithoutSellerNestedInput, {nullable:true})
    refundables?: RefundableUncheckedUpdateManyWithoutSellerNestedInput;
